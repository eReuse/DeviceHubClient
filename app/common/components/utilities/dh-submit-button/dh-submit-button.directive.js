function dhSubmitButton () {
   ...
   * @param {object} [dhSubmitButton] - An object containing a boolean property called 'loading'
   * @param {bool} dhSubmitButton.loading - A flag that sets the button in loading or not
   */
  return {
